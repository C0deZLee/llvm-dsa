...
entry:
  ...
  call void @llvm.dbg.declare(metadata i32* %argc.addr, metadata !39, metadata !19), !dbg !40
  store i8** %argv, i8*** %argv.addr, align 8
  call void @llvm.dbg.declare(metadata i8*** %argv.addr, metadata !41, metadata !19), !dbg !42
  call void @llvm.dbg.declare(metadata i32* %a, metadata !43, metadata !19), !dbg !44
  ...
  call void @llvm.dbg.declare(metadata i32* %b, metadata !47, metadata !19), !dbg !48
...
!18 = !MDLocalVariable(tag: DW_TAG_arg_variable, name: "n1", arg: 1, scope: !4, file: !1, line: 4, type: !7)
!19 = !MDExpression()
!20 = !MDLocation(line: 4, column: 32, scope: !4)
...
!39 = !MDLocalVariable(tag: DW_TAG_arg_variable, name: "argc", arg: 1, scope: !8, file: !1, line: 13, type: !11)
!40 = !MDLocation(line: 13, column: 14, scope: !8)
